    ...
    def handle(self, *args, **options):
        ...
        with requests.Session() as session_requests:
            ...
            for global_confirmed_cases_row, global_deaths_cases_row, global_recovered_cases_row in \
                ...
                # global_confirmed_cases_row[0] is Province/State global_confirmed_cases_row[1] is Country/Region
            ...
            try:
                ...
                print("Error occurred in global cases!!", e)
            ...
            for i in range(1, len(us_confirmed_cases)):
                # us_confirmed_cases_row[6] is Province/State us_confirmed_cases_row[7] is Country/Region
                # date_wise values are starting from us_confirmed_cases_row[11] and in
                # deaths from us_deaths_cases_row[12]
            ...
            try:
                ...
                print("Error occurred in US cases!!", e)
